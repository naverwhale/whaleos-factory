...
RELEASE_IMAGE_PART12_PATH='/mnt/stateful_partition/dev_image/opt/cros_payloads/release_image.part12'
...
def WipeInit(wipe_args, shopfloor_url, state_dev, release_rootfs,
  ...
  try:
    ...
    process_utils.Spawn(['dd', 'of=/dev/mmcblk0p12',
                         'if=' + RELEASE_IMAGE_PART12_PATH,
                         'bs=1048576', 'iflag=fullblock', 'oflag=dsync'],
